...
exports.getBotIntent = getBotIntent;
exports.getBookingConfirmation = getBookingConfirmation;
...
const ai = new genai_1.GoogleGenAI({ apiKey: API_KEY, vertexai: true });
...
async function getBotIntent(chatId, userMessage) {
...
async function getBookingConfirmation(details) {
    const prompt = `
...
async function getOrderConfirmation(cartItems, total) {
